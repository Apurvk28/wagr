...
export const AnimatedBorderButton: React.FC<AnimatedBorderButtonProps> = ({
  ...
  return (
    <div className="btn-border-wrap inline-block">
      <button
        className={`relative overflow-hidden rounded-full bg-dark-card border border-dark-border/80 px-6 py-3 text-xs sm:text-sm font-extrabold uppercase tracking-wider text-white shadow-xl group transition-all duration-300 ${className}`}
        {...props}
      >
